...
- `${CLAUDE_PLUGIN_ROOT}/skills-claude/references/logtype-insight.md` — read at step 7 (extract and query-pool commands, report-writer prompt, report format).
