...
tree_raw_file="${out_dir}/log-shape-schema-tree-raw.ndjson"
tree_json_file="${out_dir}/log-shape-schema-tree.json"
tree_summary_file="${out_dir}/log-shape-schema-tree.txt"
