...
diff_file="${out_dir}/log-shape-diff.out"
sample_file="${out_dir}/clp-insights-sample.ndjson"
dist_file="${out_dir}/clp-insights-dist.txt"
...
archive_stats_file="${out_dir}/clp-insights-archive-stats.ndjson"
